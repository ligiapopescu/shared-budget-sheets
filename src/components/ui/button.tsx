...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 btn-bounce",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-teal rounded-full",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-coral rounded-full",
        outline:
        ...
        ghost: "hover:bg-teal-light hover:text-primary rounded-full",
        link: "text-primary underline-offset-4 hover:underline",
        mint: "bg-mint text-white hover:bg-mint/90 shadow-mint rounded-full",
        purple: "bg-purple text-white hover:bg-purple/90 shadow-purple rounded-full",
        coral: "bg-coral text-white hover:bg-coral/90 shadow-coral rounded-full",
      },
      size: {
